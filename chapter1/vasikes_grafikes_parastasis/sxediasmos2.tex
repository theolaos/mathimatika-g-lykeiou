...
\textbf{ΠΡΟΣΟΧΗ!!!} Για να ισχύοουν οι δύο τελευταία παραδείγματα πρέπει $x + \alpha \in A$, όπου $A$ είναι το πεδίο ορισμού της συνάρτησης $f$.
